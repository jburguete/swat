...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
   ...
   real*8 :: cvwc, dt, lid_adj_ksat, lid_cuminf, lid_cumr, lid_etcoef,&
      &lid_et, lid_excum, lid_exinc, lid_f, lid_f1, lid_fc, lid_hydeff,&
      &lid_ksat, lid_por, lid_qinf, lid_qseep, lid_re_sw, lid_soldpt, lid_sw,&
      &lid_usat_ratio, lid_wp, tst, whd
   integer :: jj
