...
!!    Plus particle size tracking.
   ...
   real*8 :: bnksan, bnksil, bnkcla, bnkgra, pdep
   real*8 :: USpower,bnkrte,adddep,fpratio,watdep,bnkrt,bedrt, effbnkbed
   real*8 :: c, cychppm, cychv, cychw, deg1, deg1cla, deg1gra,&
   &deg1sag, deg1san, deg1sil, degremain, pbank, pbed, SFbank,&
   &topw, vcla, vgra, vlag, vsag, vsan, vsil, w50, dat2, deg1lag
