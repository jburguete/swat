...
caps.o: caps.f90 parm.mod Makefile
...
clgen.o: clgen.f90 parm.mod Makefile
...
dstn1.o: dstn1.f90 parm.mod Makefile
	$(cc) $(cflags) dstn1.f90 -o dstn1.o

ee.o: ee.f90 parm.mod Makefile
...
erfc.o: erfc.f90 parm.mod Makefile
	$(cc) $(cflags) erfc.f90 -o erfc.o

estimate_ksat.o: estimate_ksat.f90 parm.mod Makefile
...
expo.o: expo.f90 parm.mod Makefile
...
header.o: header.f90 parm.mod Makefile
...
jdt.o: jdt.f90 parm.mod Makefile
...
log_normal.o: log_normal.f90 parm.mod Makefile
...
nuts.o: nuts.f90 parm.mod Makefile
...
qman.o: qman.f90 parm.mod Makefile
	$(cc) $(cflags) qman.f90 -o qman.o

ran1.o: ran1.f90 parm.mod Makefile
...
soil_par.o: soil_par.f90 parm.mod Makefile
